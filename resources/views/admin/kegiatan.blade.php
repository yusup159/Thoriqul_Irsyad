                ...
                <tbody>
                    @foreach ($kegiatan as $key => $kgtn)
                        <tr>
                            ...
                            @endif
                            <td><img src="{{ asset('storage/fotokegiatan/' . basename($kgtn->fotokegiatan)) }}"
                            ...
                            @endif
                            <td><a href="{{ route('showkegiatan/admin', ['id' => $kgtn->id]) }}" type="button"
                                    class="btn btn-secondary">Lihat</a></td>
                            <td><a href="{{ route('editkegiatan/admin', ['id' => $kgtn->id]) }}" type="button"
                                    class="btn btn-success"
                                    onclick="return confirm('Yakin Akan Mengubah Data Ini?')">Edit</a></td>
                            <td><a href="{{ route('deletekegiatan/admin', ['id' => $kgtn->id]) }}" type="button"
