                ...
                <tbody>
                    <?php $__currentLoopData = $berita; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $brt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <?php endif; ?>
                            <td><img src="<?php echo e(asset('storage/fotoberita/' . basename($brt->fotoberita))); ?>"
                            ...
                            <?php endif; ?>
                            <td><a href="<?php echo e(route('showberita/admin', ['id' => $brt->id])); ?>" type="button"
                                    class="btn btn-secondary">Lihat</a></td>
                            <td><a href="<?php echo e(route('editberita/admin', ['id' => $brt->id])); ?>" type="button"
                                    class="btn btn-success"
                                    onclick="return confirm('Yakin Akan Mengubah Data Ini?')">Edit</a></td>
                            <td><a href="<?php echo e(route('deleteberita/admin', ['id' => $brt->id])); ?>" type="button"
