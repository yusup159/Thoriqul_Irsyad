<?php $__env->startSection('atassidebar'); ?>
    <div class="brand-link">
        <img src="<?php echo e(asset('lte/dist/img/AdminLTELogo.png')); ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
            style="opacity: .8">
        <p>Thoriqul Irsyad</p>
    </div>
    ...
    <div class="sidebar">
        <a href="<?php echo e(route('profil/admin')); ?>">
            <div class="user-panel mt-3 pb-3 mb-3 d-flex align-items-center">
                <div class="image">
                    <img src="<?php echo e(asset('storage/fotopengurus/' . basename(Auth::user()->fotopengurus))); ?>" alt="User Image"
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <?php if(auth()->user()->role_id != 2): ?>
                    <li class="nav-item">
                        <a href="<?php echo e(route('datauser/admin')); ?>"
                            class="nav-link <?php echo e(request()->routeIs('datauser/admin') ? 'active' : ''); ?>">
                ...
                <li class="nav-item">
                    <?php if(auth()->user()->role_id == 2): ?>
                        <a href="<?php echo e(route('dashboard/pengurus')); ?>"
                            class="nav-link <?php echo e(request()->routeIs('dashboard/pengurus') ? 'active' : ''); ?>">
                        <?php else: ?>
                            <a href="<?php echo e(route('dashboard/admin')); ?>"
                                class="nav-link <?php echo e(request()->routeIs('dashboard/admin') ? 'active' : ''); ?>">
                    <?php endif; ?>
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('datakegiatan/admin')); ?>"
                        class="nav-link <?php echo e(request()->routeIs('datakegiatan/admin') ? 'active' : ''); ?>">
                        <i class="nav-icon fas fa-th"></i>
                        <p>
                            Kegiatan
                        </p>
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('databerita/admin')); ?>"
                        class="nav-link <?php echo e(request()->routeIs('databerita/admin') ? 'active' : ''); ?>">
                ...
                <tbody>
                    <?php $__currentLoopData = $kegiatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $kgtn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <?php endif; ?>
                            <td><img src="<?php echo e(asset('storage/fotokegiatan/' . basename($kgtn->fotokegiatan))); ?>"
                            ...
                            <?php endif; ?>
                            <td><a href="<?php echo e(route('showkegiatan/admin', ['id' => $kgtn->id])); ?>" type="button"
                                    class="btn btn-secondary">Lihat</a></td>
                            <td><a href="<?php echo e(route('editkegiatan/admin', ['id' => $kgtn->id])); ?>" type="button"
                                    class="btn btn-success"
                                    onclick="return confirm('Yakin Akan Mengubah Data Ini?')">Edit</a></td>
                            <td><a href="<?php echo e(route('deletekegiatan/admin', ['id' => $kgtn->id])); ?>" type="button"
